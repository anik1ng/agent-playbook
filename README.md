...
- **`UPDATE.md`** (whenever the playbook moves): *"Read UPDATE.md from
  github.com/anik1ng/agent-playbook and sync this repository."* Syncs the files that
  never diverge, keeps the ones that do, and shows every difference before writing.
...
scripts/*.mts                      optional worktree module: task:start / task:finish
```
