...
#
# Where the human runs an interactive reviewer and a notification command
# exists on this machine, announce the "ask" before answering it — see
# integrations/cmux.md, socket 4. Any such line is best-effort and must never
# change the decision or the exit status.
